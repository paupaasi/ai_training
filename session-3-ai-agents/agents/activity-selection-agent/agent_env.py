"""Load .env / .env.local from the agent folder and each parent directory (e.g. repo root)."""
...
def load_agent_environment() -> None:
    ...
    activity-selection-agent/.env.local wins over ../../.env.local at the monorepo root.
    """
